...
sql="select * from article where web=3 and id="&id
...
<table width="950" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><div align="center"><img src="images/banner3.jpg" alt="banner" width="950" height="159" /></div></td>
  </tr>
  <tr>
    <td width="650" height="31"><strong>您现在所在的位置：
      <%
'response.write(rs("father"))
father=rs("father")
if father="0" then
	response.Write("<a target='_self' href='web3.asp?id=1'>"&"首页"&"</a>")
else
	nodes=split(father,"/")
	set rs2=server.CreateObject("ADODB.recordset")
	For j = LBound(nodes) To UBound(nodes)
		sql2="select * from article where web=3 and id="&nodes(j)
		rs2.open sql2,conn,1,3
		response.Write("<a target='_self' href='web3.asp?id="&nodes(j)&"'>"&rs2("pagename")&"</a>"&" -> ")
		rs2.close
    Next
	response.Write("<a target='_self' href='web3.asp?id="&id&"'>"&rs("pagename")&"</a>")
	set rs2=nothing
end if
%>
    </strong></td>
    <td width="300" rowspan="2" align="center" valign="top" background="images/right2_btm.jpg"><table width="300" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="600" valign="top"><%if session("judge2")=4 then%>
        <script language="JavaScript" type="text/javascript"> 
var specialcode="<div id=\'ad3\'><br /><p><img src=\'images/ad31.jpg\' alt=\'5\' width=\'270\' height=\'70\' /></p><p><img src=\'images/ad33.jpg\' alt=\'6\' width=\'270\' height=\'70\' /></p></div>";
...
if session("judge2")=3 then%>
        <div id="ad2"><p>&nbsp;</p>
          <p><img src="images/ad31.jpg" alt="5" width="270" height="70" /></p>
          <p><img src="images/ad33.jpg" alt="7" width="270" height="70" /></p>
          <p>&nbsp;</p>
          <br  />
        </div>
      <% end if %>
  ...
  <tr>
    <td width="650" align="left" valign="top"><br />
   	  <%=rs("field1")%>
   	  <br />
   	  <br />
<%if session("judge2")=2 then%>
      <div id="ad1_1">
        <div align="center"><img src="images/ad31.jpg" width="270" height="70" />  <img src="images/ad33.jpg" width="270" height="70" /></div>
      </div>
<% end if %>
      <br />
      <%=rs("field2")%>
