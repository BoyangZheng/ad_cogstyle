...
sql="select * from article where web=2 and id="&id
...
<table width="950" border="0" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2"><div align="center"><img src="images/banner2.jpg" alt="banner" width="948" height="142" /></div></td>
  </tr>
  <tr>
  	<td width="300" rowspan="2" align="center" valign="top" background="images/left2.jpg">
<%if session("judge2")=4 then%>
	  <script language="javascript"> 
var specialcode="<div id=\'ad3\'><br /><p><img src=\'images/ad22.jpg\' alt=\'6\' width=\'270\' height=\'70\' /></p><p><img src=\'images/ad23.jpg\' alt=\'8\' width=\'270\' height=\'70\' /></p><br  /></div>";
...
<div id="ad2"><br /><p>&nbsp;</p>
<p><img src="images/ad22.jpg" alt="6" width="270" height="70" /></p><p><img src="images/ad23.jpg" alt="7" width="270" height="70" /></p><p>&nbsp;</p>
<br  /></div>
<% end if %>
    </td>
...
father=rs("father")
if father="0" then
	response.Write("<a target='_self' href='web2.asp?id=1'>"&"首页"&"</a>")
else
	nodes=split(father,"/")
	set rs2=server.CreateObject("ADODB.recordset")
	For j = LBound(nodes) To UBound(nodes)
		sql2="select * from article where web=2 and id="&nodes(j)
		rs2.open sql2,conn,1,3
		response.Write("<a target='_self' href='web2.asp?id="&nodes(j)&"'>"&rs2("pagename")&"</a>"&" -> ")
		rs2.close
    Next
	response.Write("<a target='_self' href='web2.asp?id="&id&"'>"&rs("pagename")&"</a>")
	set rs2=nothing
end if
%>
    </strong></td>
  ...
  <tr>
    <td width="650" align="left" valign="top" bgcolor="#FFFFFF"  <%="class=""href""" %>><br />
   	  <%=rs("field1")%>
   	  <br />
   	  <br />
<%if session("judge2")=2 then%>
      <div id="ad1_1">
        <div align="center"><img src="images/ad22.jpg" width="270" height="70" />&nbsp;<img src="images/ad23.jpg" width="270" height="70" /></div>
      </div>
<% end if %>
      <br />
      <%=rs("field2")%>
